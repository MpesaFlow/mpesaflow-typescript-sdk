 ...
 * Customers Not Found
 */
export type GetCustomersResponseBodyData = {
  message: string;
};
 ...
 * Customers Not Found
 */
export class GetCustomersResponseBody extends Error {
  /** The original data that was passed to this error instance. */
  data$: GetCustomersResponseBodyData;

  constructor(err: GetCustomersResponseBodyData) {
    ...
    this.name = "GetCustomersResponseBody";
  }
}
...
> = z.object({
  ...
  .transform((v) => {
    return new GetCustomersResponseBody(v);
  });
...
export const GetCustomersResponseBody$outboundSchema: z.ZodType<
  ...
  z.ZodTypeDef,
  GetCustomersResponseBody
> = z.instanceof(GetCustomersResponseBody)
  .transform(v => v.data$)
  .pipe(z.object({
    message: z.string(),
  }));
